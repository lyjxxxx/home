<template>
  ...
  <Transition name="fade" mode="out-in">
    <main id="main" v-if="store.imgLoadStatus">
      <BlankPage v-if="store.activePage !== 'home'" />
      <div class="container" v-show="!store.backgroundShow && store.activePage === 'home'">
      ...
      <Icon
        class="menu"
        size="24"
        v-show="!store.backgroundShow && store.activePage === 'home'"
      ...
      <Transition name="fade" mode="out-in">
        <Footer
          class="f-ter"
          v-show="!store.backgroundShow && !store.setOpenState && store.activePage === 'home'"
        />
      </Transition>
    </main>
  </Transition>
...
const syncPageFromHash = () => {
  ...
  store.setActivePage(page, pageRoutes[page] || "");
};
